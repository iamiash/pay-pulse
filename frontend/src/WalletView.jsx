  ...
  return (
    <div className="dashboard-container">
      <header className="header">
        <div>
          <h1 style={{ margin: 0 }}>💳 PayPulse Wallet</h1>
          <p style={{ color: '#94a3b8', margin: '0.25rem 0 0 0' }}>SQLite Persistent Wallet & Subscription Manager</p>
        </div>
      ...
      {data && (
        <>
          ...
          <section>
            <h2 style={{ fontSize: '1.25rem', marginBottom: '1rem' }}>Active Subscriptions</h2>
